...
alg5 = XGBRegressor(objective ='reg:linear', colsample_bytree = 0.3, learning_rate = 0.2,max_depth = 6, alpha = 10, n_estimators = 200)
modelfit(alg5, train, test, predictors, target, IDcol, 'alg6.csv')
