...
alg5 = GradientBoostingRegressor(n_estimators=400,learning_rate=1.0, max_depth=6,max_leaf_nodes=6)
modelfit(alg5, train, test, predictors, target, IDcol, 'alg7.csv')
